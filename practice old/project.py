   ...
   #To avoid input other than expected groups         
    ...
    while True:
        ...
        if(group== "Commerce"):
            False
            break
        if(group!= "Science" or "General" or "Commerce"):
    ...
    if(group=="Science" and grade==9):
        l = ns
        search(book)
    if (group=="General" and grade==9):
        l=ng
        search(book)
    if (group=="Science" and grade==10):
        l=ms
        search(book)
    if  (group=="General" and grade==10):
        l=mg
        search(book)
    if  (group=="Science" and grade==11):
        l=es
        search(book)
    if  (group=="Commerce" and grade==11):
        l=ec
        search(book)
    if  (group=="Science" and grade==12):
        l=ts
        search(book)
    if  (group=="Commerce" and grade==12):
        l=tc
        search(book)
